...
def _jsontocsv(jsoninput, allowedhash, notallowedhash):
	...
	# if t_place is not None and t_place != "null" and t_place != "":
	# 	outvalue += Location2Country(t_place.replace(", ","-")) + ","	 
	# elif u_location is not None and u_location != "null" and u_location != "":
	# 	outvalue += Location2Country(u_location.replace(", ","-")) + ","
	# else:
	outvalue += "null,"	 
...
# rootdir4 = "/media/aydarusman/Elements/Research File/Crimean Crisis Dataset/04"
rootdir2 = "/home/masdarcis/Documents/projects_amalfi/twitter_data/programs/codes/02"
...
print "Processing February!!!"
count = 1
errordir = rootdir2 + "/errorfile.error"
errorfile = open(errordir, "w")
outputdir = rootdir2 + "/result.csv"
